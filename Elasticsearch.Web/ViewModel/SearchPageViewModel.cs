namespace Elasticsearch.Web.ViewModel
{
    public class SearchPageViewModel
    {
        ...
        public List<ECommerseViewModel> List { get; set; }
        public ECommerseSearchViewModel SearchViewModel { get; set; }

        public int StartPage()
        {
            return Page - 6 <= 0 ? 0 : Page - 6;
        }
        ...
        {
            //https://(www or localhost)/search?sfsf
